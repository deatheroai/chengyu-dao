...
export const idioms: IdiomContent[] = [
  // --- Focus & Perseverance ---
  {
    ...
    scenarioShort: "Doing homework at the table, ignoring the TV and toys nearby.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Finishing the whole swimming course, even after it got hard.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Wanting to stop halfway through building a LEGO set together.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Getting better at basketball after practising every week.",
    exampleSentence: {
      hanzi: "弹钢琴要多多练习，熟能生巧。",
  ...
  },
  {
    ...
    scenarioShort: "Practising a hard recorder song for weeks without giving up.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Trying to skip training wheels before practising the basics.",
    exampleSentence: {
  ...
  // --- Honesty & Character ---
  {
    ...
    scenarioShort: "Remembering to bring the storybook you promised to lend a friend.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Saying sorry and helping rebuild a tower you knocked over.",
    exampleSentence: {
  ...
  // --- Kindness & Community ---
  {
    ...
    scenarioShort: "Stopping to help a classmate who dropped their books.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Everyone in the group helping build the science project together.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "The whole family cooking dinner and sharing stories together.",
    exampleSentence: {
  ...
  // --- Wisdom & Learning ---
  {
    ...
    scenarioShort: "Reviewing last month's spelling words before a new test.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Hoping to do well on a test just by luck, without studying.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Realising there's so much more to learn after visiting an art museum.",
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: "Walking to school with dad — exercise and time together at once.",
    exampleSentence: {
