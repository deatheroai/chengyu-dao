...
export const idioms: IdiomContent[] = [
  // --- Focus & Perseverance ---
  {
    ...
    scenarioShort: { hanzi: "写功课的时候，电视开着，玩具也在旁边，他还是认真写完了。", pinyin: "Xiě gōngkè de shíhou, diànshì kāizhe, wánjù yě zài pángbiān, tā háishi rènzhēn xiě wán le." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "游泳课很难，但是他还是坚持上完了整个课程。", pinyin: "Yóuyǒng kè hěn nán, dànshì tā háishi jiānchí shàng wán le zhěnggè kèchéng." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "两个人一起拼乐高，拼到一半，朋友就想去玩别的了。", pinyin: "Liǎng gè rén yìqǐ pīn lègāo, pīn dào yíbàn, péngyou jiù xiǎng qù wán bié de le." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "他每个星期都练习投篮，慢慢地就投得很准了。", pinyin: "Tā měi gè xīngqī dōu liànxí tóulán, mànmàn de jiù tóu de hěn zhǔn le." },
    exampleSentence: {
      hanzi: "弹钢琴要多多练习，熟能生巧。",
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "这首直笛曲很难，他练习了好几个星期，还是没有放弃。", pinyin: "Zhè shǒu zhídí qǔ hěn nán, tā liànxí le hǎo jǐ gè xīngqī, háishi méiyǒu fàngqì." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "他还没有练好基本功，就想马上拿掉脚踏车的辅助轮。", pinyin: "Tā hái méiyǒu liàn hǎo jīběngōng, jiù xiǎng mǎshàng ná diào jiǎotàchē de fǔzhùlún." },
    exampleSentence: {
  ...
  // --- Honesty & Character ---
  {
    ...
    scenarioShort: { hanzi: "他答应把故事书借给朋友，第二天真的记得带来了。", pinyin: "Tā dāying bǎ gùshi shū jiè gěi péngyou, dì-èr tiān zhēn de jìde dài lái le." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "他不小心撞倒了妹妹的积木塔，马上说对不起，还帮忙重新搭好。", pinyin: "Tā bù xiǎoxīn zhuàng dǎo le mèimei de jīmù tǎ, mǎshàng shuō duìbuqǐ, hái bāngmáng chóngxīn dā hǎo." },
    exampleSentence: {
  ...
  // --- Kindness & Community ---
  {
    ...
    scenarioShort: { hanzi: "下课的时候，同学摔倒了，书本掉了一地，他马上过去帮忙捡起来。", pinyin: "Xiàkè de shíhou, tóngxué shuāi dǎo le, shūběn diào le yí dì, tā mǎshàng guòqù bāngmáng jiǎn qǐlai." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "科学作业需要大家一起做，同学们互相帮忙，没有人吵架。", pinyin: "Kēxué zuòyè xūyào dàjiā yìqǐ zuò, tóngxuémen hùxiāng bāngmáng, méiyǒu rén chǎojià." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "星期天，全家人一起做饭，一起吃饭，一起说说笑笑。", pinyin: "Xīngqītiān, quánjiā rén yìqǐ zuò fàn, yìqǐ chī fàn, yìqǐ shuōshuo-xiàoxiào." },
    exampleSentence: {
  ...
  // --- Wisdom & Learning ---
  {
    ...
    scenarioShort: { hanzi: "考试前，他把上个月学过的生字拿出来再复习一遍。", pinyin: "Kǎoshì qián, tā bǎ shàng gè yuè xuéguò de shēngzì ná chūlai zài fùxí yí biàn." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "考试前他什么都没有复习，只希望考试能靠运气考好。", pinyin: "Kǎoshì qián tā shénme dōu méiyǒu fùxí, zhǐ xīwàng kǎoshì néng kào yùnqi kǎo hǎo." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "参观美术馆以后，他才发现原来还有很多不同的画法可以学习。", pinyin: "Cānguān měishùguǎn yǐhòu, tā cái fāxiàn yuánlái hái yǒu hěn duō bùtóng de huàfǎ kěyǐ xuéxí." },
    exampleSentence: {
  ...
  },
  {
    ...
    scenarioShort: { hanzi: "走路去学校，不但可以运动，还可以和爸爸聊天。", pinyin: "Zǒulù qù xuéxiào, búdàn kěyǐ yùndòng, hái kěyǐ hé bàba liáotiān." },
    exampleSentence: {
